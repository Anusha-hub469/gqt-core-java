...
public class QuizGame {
    ...
    public static void main(String[] args) {
        ...
        // Display player details with colors
        System.out.println("\n🎮 Welcome to the Quiz Game!");
        System.out.println("Player Info:");
        System.out.println(GREEN + "Name: " + name + RESET);
        System.out.println(BLUE + "Email: " + email + RESET);
        System.out.println(YELLOW + "City: " + city + RESET);
        System.out.println(CYAN + "State: " + state + RESET);
